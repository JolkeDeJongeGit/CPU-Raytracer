...
/**
 *  \brief A variable that determines whether ctrl+click should generate a m_Right-click event on Mac
 *  
 *  If present, holding ctrl while m_Left clicking will generate a m_Right click
 *  event when on Mac.
 */
